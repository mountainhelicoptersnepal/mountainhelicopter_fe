...
const NAV_LINKS = [
  {
    ...
    dropdown: [
      ...
      },
      {
        ...
        description: "Fast helicopter return from the Everest trail.",
      },
      {
        title: "Kathmandu to Lukla",
        href: "/tours/kathmandu-lukla-helicopter",
        description: "Direct transfer to the gateway of the Everest region.",
      },
      {
        title: "Ramechhap to Lukla",
        href: "/tours/ramechhap-lukla-helicopter",
        description: "Convenient helicopter transfer into Lukla.",
      },
    ],
  },
  // {
