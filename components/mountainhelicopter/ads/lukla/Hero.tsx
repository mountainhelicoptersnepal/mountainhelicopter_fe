    ...
    <div className="relative overflow-hidden bg-[linear-gradient(160deg,#0C4396_0%,#082F6B_52%,#051F49_100%)] py-16 text-white sm:py-[66px]">
      ...
      <div className="relative mx-auto grid max-w-[1160px] gap-8 px-[22px] sm:gap-12 md:grid-cols-[1.15fr_.92fr] md:gap-14">
        <div className="pt-2 md:pt-6 lg:pt-[34px]">
          <span className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-[#F5AF00]/40 bg-[#F5AF00]/[.12] px-4 py-2 font-jetbrains-mono text-xs font-semibold uppercase tracking-[.14em] text-[#F5AF00]">
          ...
          <div className="mt-6 flex flex-wrap gap-x-[22px] gap-y-2 font-jetbrains-mono text-[13px] uppercase tracking-[.05em] text-[#A9C2E8]">
