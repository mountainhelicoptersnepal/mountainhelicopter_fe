        ...
        <Reveal className="grid grid-cols-2 gap-3.5 lg:grid-cols-4">
          {PHOTOS.map((photo) => (
            ...
            >
              ...
              />
              <figcaption className="absolute inset-x-0 bottom-0 bg-[linear-gradient(transparent,rgba(5,31,73,.85))] px-3.5 pb-2.5 pt-5 font-manrope text-[11px] uppercase tracking-[.08em] text-white">
                {photo.caption}
              </figcaption>
            </figure>
          ))}
