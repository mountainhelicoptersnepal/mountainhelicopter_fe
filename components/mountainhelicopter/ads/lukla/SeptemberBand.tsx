...
export default function SeptemberBand() {
  return (
    <section className="bg-[linear-gradient(120deg,#F2B632_0%,#f5a623_100%)] py-[50px] text-[#0d1a2d]">
      <div className="mx-auto flex max-w-[1160px] flex-wrap items-center justify-between gap-[22px] px-[22px]">
        ...
        <Reveal delay={0.1}>
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full bg-[#003366] px-6 py-3.5 text-[15px] font-bold tracking-[.02em] text-white shadow-[0_6px_18px_rgba(8,47,107,.3)] transition hover:bg-[#0D4DAC] active:scale-[.98]"
          >
