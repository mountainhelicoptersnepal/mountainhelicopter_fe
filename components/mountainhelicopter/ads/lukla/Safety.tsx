        ...
        <div className="grid grid-cols-2 gap-5 lg:grid-cols-4">
          {STATS.map((stat, i) => (
            <Reveal key={stat.v} delay={i * 0.06}>
              <div className="h-full rounded-[10px] border border-[#D7E2F2] border-l-4 border-l-[#003366] bg-white p-[22px_20px]">
                <div className="font-manrope text-[1.2rem] font-semibold text-[#003366]">
                  {stat.v}
                </div>
