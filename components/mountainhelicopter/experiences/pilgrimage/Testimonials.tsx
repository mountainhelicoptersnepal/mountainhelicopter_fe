...
const testimonials = [
  {
    quote:
      "My mother is 74 and has spoken of Muktinath since before I was born. Her knees ended the trekking dream twenty years ago. These pilots carried her to her god in one morning. She stood under the 108 waterspouts and wept.",
    name: "Priya Sharma",
    experience: "Muktinath Darshan",
    location: "India",
    accent: "gold",
  },
  {
    quote:
      "I am 68 and had accepted that Kailash would remain a photograph on my wall. The entire journey was planned around my health. When Mansarovar appeared below the aircraft, forty years of wanting ended at once.",
    name: "Mahendra Agrawal",
    experience: "Kailash–Mansarovar Yatra",
    location: "India",
    accent: "blue",
  },
];
...
export default function Testimonials() {
  return (
    <article aria-labelledby="reviews-heading">
      ...
      >
        Pilgrims who have made this journey.
      </h2>
