const months = [
  {
    name: "Jan",
    description: "High passes cold-limited",
    status: "limited",
  },
  {
    name: "Feb",
  ...
  {
    name: "Mar",
    description: "Pilgrimage season opens",
    status: "peak",
  },
  {
    name: "Apr",
    description: "Warm mornings and clear routes",
    status: "peak",
  },
  {
    name: "May",
    description: "Kailash yatra window opens",
    status: "peak",
  },
  {
    name: "Jun",
  ...
  {
    name: "Aug",
    description: "Weather-dependent festival flights",
    status: "limited",
  },
  {
    name: "Sep",
    description: "Skies clear and season resumes",
    status: "peak",
  },
  {
    name: "Oct",
  ...
  {
    name: "Nov",
    description: "Sharp mountain visibility",
    status: "peak",
  },
  {
    name: "Dec",
    description: "Cold and quiet shrines",
    status: "good",
  },
];
...
export default function SeasonGuide() {
  return (
    <article aria-labelledby="season-heading">
      ...
      >
        The sacred calendar, month by month.
      </h2>
