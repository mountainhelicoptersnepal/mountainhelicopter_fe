...
const relatedExperiences = [
  {
    ...
    description:
      "A private picnic on a Himalayan ridge accessible by helicopter.",
    image: "/images/experiences/heli-picnic.png",
    href: "/experiences/heli-picnic",
  },
  {
    title: "The Mountains, on Your Schedule",
    category: "Private Charter",
    description:
      "Your route, timings and aircraft arranged around your private journey.",
