const months = [
  ...
  {
    name: "Apr",
    description: "Popular spring month",
    status: "peak",
  },
  {
    name: "May",
    description: "Warmer with possible haze",
    status: "good",
  },
  {
    name: "Jun",
    description: "Monsoon conditions",
    status: "closed",
  },
  {
    name: "Jul",
  ...
  {
    name: "Nov",
    description: "Excellent mountain clarity",
    status: "peak",
  },
  {
    name: "Dec",
    ...
    <article aria-labelledby="season-heading">
      ...
      <div className="overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-12">
          {months.map((month) => (
            ...
            >
              ...
              <p className="mt-3 text-[10px] leading-[1.4] text-[#475569]">
                {month.description}
              </p>
            </div>
          ))}
        ...
        <div className="flex flex-wrap gap-5 border-t border-[#E2E8F0] bg-[#F8FAFC] px-5 py-4">
          <span className="inline-flex items-center gap-2 text-xs text-[#475569]">
