...
const relatedExperiences = [
  {
    ...
    category: "Kala Patthar",
    description:
      "A high-altitude Himalayan landing with a close view of the Everest region.",
  ...
  },
  {
    ...
    description:
      "A private aircraft and customized route designed around your schedule.",
  ...
  },
  {
    ...
    description:
      "A private picnic experience on a secluded Himalayan ridge.",
