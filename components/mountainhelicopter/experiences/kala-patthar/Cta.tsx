    ...
    <section className="relative overflow-hidden bg-[#0d1a2d]">
      ...
      <div className="relative z-[2] mx-auto max-w-7xl px-6 py-16 text-center md:px-12 md:py-24 lg:px-16 lg:py-28">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/contact"
            className="group relative isolate flex h-[46px] w-full max-w-[260px] items-center justify-center overflow-hidden bg-[#f5a623] px-5 font-manrope text-[13px] font-bold uppercase tracking-[-0.01em] text-[#06203c] transition-colors duration-700 hover:text-[#f5a623] sm:w-[202px] sm:text-[14px]"
          >
