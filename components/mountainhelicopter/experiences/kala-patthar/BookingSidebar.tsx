...
const whatsappMessage =
  "Hello! I would like to book the Kala Patthar Landing experience.";
...
const benefits = [
  "Oxygen onboard as standard",
  "Free reschedule on weather",
  "17 years of Khumbu landings",
];

const addOns = [
  {
    title: "Everest View breakfast",
    description: "Descend to the terrace at 3,880 m after the ridge",
    price: "+ USD 200",
  },
  {
    title: "Photographer",
    description: "Edited gallery in 72 hours",
    price: "+ USD 350",
  },
  {
    title: "Video package",
    description: "Cinematic edit of your landing, aerials included",
    price: "+ USD 500",
  },
];
    ...
    <aside id="booking" aria-label="Booking information" className="space-y-5">
      ...
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6">
        ...
        <p className="mt-3 text-xs leading-relaxed text-[#475569]">
          Gold = peak clarity. Monsoon from June to August is not flown for this
          route.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[#003366]/15 bg-[#E6F0F8] p-6">
        <div className="mb-3 flex items-center gap-3">
          ...
          <p className="text-sm font-bold text-[#003366]">
            Flown by the rescue crews
          </p>
        </div>

        <p className="text-xs leading-relaxed text-[#0A1929]/75">
          The same CAAN-certified pilots who fly 24/7 high-altitude rescue
          missions above 5,000 m fly your landing. 17 years, zero compromises.
        </p>
      </div>
    </aside>
  );
