...
const whatsappMessage =
  "Hello! I would like to design a private helicopter charter in Nepal.";
...
const benefits = [
  "Personal route-planning support",
  "Transparent quotation before confirmation",
...
const addOns = [
  {
    ...
    description: "For larger groups or coordinated travel",
    price: "Quote",
  },
  {
    title: "Overnight positioning",
    description: "For selected multi-day itineraries",
    price: "Quote",
  },
  {
    title: "Private catering",
    description: "Meals arranged at selected landing stops",
    price: "Quote",
  },
];
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-[#003366] p-8 text-white shadow-[0_20px_40px_rgba(0,51,102,0.18)]">
        ...
        <div className="relative">
          ...
          <p className="mb-7 text-xs leading-relaxed text-white/70">
            Pricing depends on route, flight time, passengers, permits, landing
            arrangements and additional services.
          </p>
      ...
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6">
        ...
        <p className="mt-3 text-xs leading-relaxed text-[#475569]">
          Gold indicates the main Himalayan flying periods. Monsoon routes
          depend heavily on destination and weather.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[#003366]/15 bg-[#E6F0F8] p-6">
        <div className="mb-3 flex items-center gap-3">
          ...
          <p className="text-sm font-bold text-[#003366]">
            Every itinerary is operationally reviewed
          </p>
        </div>

        <p className="text-xs leading-[1.75] text-[#0A1929]/75">
          The final route depends on weather, passenger weight, landing-site
          conditions, permits, fuel planning, aircraft performance and the
          decision of the Pilot in Command.
        </p>
      </div>
    </aside>
  );
