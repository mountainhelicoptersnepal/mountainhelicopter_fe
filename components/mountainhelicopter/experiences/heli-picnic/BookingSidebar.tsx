...
const addOns = [
  {
    ...
    description: "Chilled and served at the picnic site",
    price: "+ USD 90",
  },
  {
    title: "Birthday or anniversary cake",
    description: "Prepared by a Kathmandu patisserie",
    price: "+ USD 60",
  },
  {
    title: "Photographer",
    description: "Edited gallery after the experience",
    price: "+ USD 350",
  },
];
    ...
    <aside id="booking" aria-label="Booking information" className="space-y-5">
      <div className="relative overflow-hidden rounded-3xl bg-[#003366] p-8 text-white shadow-[0_20px_40px_rgba(0,51,102,0.18)]">
        ...
        <div className="relative">
          ...
          <p className="mb-7 text-xs leading-relaxed text-white/70">
            Starting price for a private group of up to five guests.
          </p>
      ...
      <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6">
        ...
        <p className="mt-3 text-xs leading-relaxed text-[#475569]">
          Gold indicates peak ridge-picnic months. Monsoon flights may use lower
          valley locations.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[#003366]/15 bg-[#E6F0F8] p-6">
        <div className="mb-3 flex items-center gap-3">
          ...
          <p className="text-sm font-bold text-[#003366]">
            Operated by experienced Himalayan crews
          </p>
        </div>

        <p className="text-xs leading-[1.75] text-[#0A1929]/75">
          The location and duration are confirmed according to weather,
          passenger weight, landing-site condition, aircraft capability and the
          final safety decision of the Pilot in Command.
        </p>
      </div>
    </aside>
  );
