const comparisonRows = [
  {
    label: "Other diners",
    restaurant: "Hundreds of people",
    ridge: "Zero",
  },
  {
    label: "The view",
    restaurant: "A wall or a window",
    ridge: "A full Himalayan panorama",
  },
  {
    label: "Reservation",
    restaurant: "A fixed table and time",
    ridge: "A date and route designed for you",
  },
  {
    label: "Dress code",
    restaurant: "Formal requirements",
    ridge: "Warm mountain clothing",
  },
  {
    label: "Phone signal",
    restaurant: "Usually available",
    ridge: "Often unavailable",
  },
  {
    label: "The story afterwards",
    restaurant: "A pleasant meal",
    ridge: "A private Himalayan experience",
  },
];
...
export default function Comparison() {
  return (
    <article aria-labelledby="comparison-heading">
      ...
      >
        A restaurant vs. your ridge.
      </h2>

      <p className="mb-8 mt-4 max-w-[600px] leading-[1.75] text-[#475569]">
        The meal may begin in a Kathmandu kitchen, but the setting changes the
      ...
      <p className="mt-4 text-xs italic text-[#475569]">
        One of these may be forgotten by Friday.
      </p>
    </article>
  );
}