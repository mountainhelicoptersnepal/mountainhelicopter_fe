const months = [
  {
    name: "Jan",
    description: "Clear air and empty hills",
    status: "good",
  },
  {
    name: "Feb",
    description: "Crisp light and quiet season",
    status: "good",
  },
  {
    name: "Mar",
    description: "Warmth returns to the ridges",
    status: "peak",
  },
  {
    name: "Apr",
    description: "Rhododendron bloom",
    status: "peak",
  },
  {
    name: "May",
    description: "Long, warm picnic afternoons",
    status: "peak",
  },
  {
    name: "Jun",
  ...
  {
    name: "Sep",
    description: "Green hills and clearing skies",
    status: "good",
  },
  {
    name: "Oct",
    description: "Classic flying month",
    status: "peak",
  },
  {
    name: "Nov",
    description: "Sharp mountain panoramas",
    status: "peak",
  },
  {
    name: "Dec",
