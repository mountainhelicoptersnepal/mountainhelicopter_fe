...
const testimonials = [
  {
    quote:
      "For our twentieth anniversary we considered Paris and the Maldives. Instead, we ate Nepali food and drank champagne on a ridge surrounded by snow peaks, with nobody else around.",
    name: "Priya & Daniel Whitmore",
    experience: "20th Anniversary",
    location: "United Kingdom",
    accent: "gold",
  },
  {
    quote:
      "Our leadership retreat ended with lunch on a ridge that nobody could point to on a map. Two hours without phone signal produced more honest conversation than several days in conference rooms.",
    name: "Sanjana Mehta",
...
export default function Testimonials() {
  return (
    <article aria-labelledby="reviews-heading">
      ...
      >
        Guests who have had this table.
      </h2>
