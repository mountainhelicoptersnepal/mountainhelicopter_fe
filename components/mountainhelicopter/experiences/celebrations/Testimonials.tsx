...
const testimonials = [
  {
    quote:
      "The team prepared a decoy itinerary and arranged the photographer without revealing anything. The landing looked like an ordinary photo stop until I asked the question.",
    name: "Daniel Kim",
    experience: "Proposal Flight",
    location: "South Korea",
    accent: "gold",
  },
  {
    quote:
      "Our children arranged a private mountain flight for our anniversary. We repeated our vows on the ridge and had no idea the whole family had been planning it for weeks.",
    name: "Margaret Ellery",
    experience: "Anniversary Re-Vows",
...
export default function Testimonials() {
  return (
    <article aria-labelledby="reviews-heading">
      ...
      >
        Guests who celebrated up there.
      </h2>
