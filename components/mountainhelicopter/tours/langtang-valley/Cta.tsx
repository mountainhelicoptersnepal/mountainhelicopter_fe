...
export default function CTA() {
  ...
  const message =
    "Hi, I have a quick question about the Langtang Helicopter Tour.";
  ...
  return (
    <section className="relative flex min-h-[620px] w-full items-center justify-center overflow-hidden bg-[#0d1a2d]">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[90px] bg-gradient-to-b from-transparent to-[#0d1a2d]" />
    </section>
  );
}
