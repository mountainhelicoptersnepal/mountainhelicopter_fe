const itineraryItems = [
  {
    ...
    description: ["Share your preferred date, passenger count, exact weights, and baggage details so the operations team can verify aircraft availability, weather, airport status, and payload."],
  },
  {
    number: "02",
    title: "Arrival at Tribhuvan International Airport",
    description: ["Passengers complete identification checks, weighing, baggage checks, and a safety briefing before boarding."],
  },
  {
    number: "03",
    title: "Departure from Kathmandu",
    description: ["The helicopter departs Kathmandu and heads north towards Rasuwa and the Langtang region."],
  },
  {
    number: "04",
    title: "Flight Towards Rasuwa and Syabrubesi",
    description: ["The route passes hills, river valleys, forests, villages, and the gateway settlements below the Langtang Valley."],
  },
  {
    number: "05",
    title: "Entering Langtang Valley",
    description: ["The valley narrows and the mountain walls rise around the aircraft as Langtang Lirung and surrounding peaks come into view."],
  },
  {
    number: "06",
    title: "Landing at Kyanjin Gompa (Approximately 3,870 m)",
    description: ["When conditions permit, the helicopter lands at Kyanjin Gompa for a brief high-altitude stop controlled by the pilot."],
  },
  {
    number: "07",
    title: "Return Flight to Kathmandu",
    description: ["Passengers return to Kathmandu by helicopter, with timing and routing depending on weather and air-traffic instructions."],
  }
];
