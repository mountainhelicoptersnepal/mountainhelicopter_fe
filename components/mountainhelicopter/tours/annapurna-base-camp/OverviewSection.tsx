...
import AnnapurnaTourSidebar from "./AnnapurnaTourSidebar";
...
const quickFacts = [
  {
    icon: ShieldCheck,
    label: "Safety",
    value: "Experienced high-altitude pilots and weather-dependent operations",
  },
  {
    icon: Clock3,
    label: "Duration",
    value: "Approximately 1.5 hours each way from Kathmandu",
  },
  {
    icon: Mountain,
