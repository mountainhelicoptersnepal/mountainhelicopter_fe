...
const plans = [
  {
    ...
    features: [
      ...
      "Shared seat when passenger matching is available",
      ...
      <div className="mx-auto w-full max-w-7xl px-6 md:px-12 lg:px-16 py-16 md:py-24 lg:py-28">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-[620px] font-manrope text-[14px] leading-7 text-[#7b8795] sm:text-[15px]">
            Shared by the seat, or the cabin to yourselves. Both fly direct from
            Ramechhap to Lukla.
          </p>
        </div>
        ...
        <p className="mt-8 text-center font-manrope text-[12px] leading-6 text-[#7b8795] sm:text-[13px]">
          Fares exclude: national park fees, Lukla airport tax, meals,
          gratuities, additional filming, separately transported baggage, and
          delay-related accommodation or meals.
        </p>
      </div>
    </section>
  );
