            ...
            <main className="min-w-0">
              ...
              <section className="mt-16 bg-white">
                ...
                <div className="max-w-6xl font-manrope text-base leading-8 text-[#687482]">
                  <p>
                    The Ramechhap to Lukla helicopter flight is a direct airway
                    from Ramechhap Airport in Manthali, Ramechhap, to
                    Tenzing-Hillary Airport in Lukla. This flight is mainly
                    arranged when scheduled fixed-wing flights are delayed,
                    canceled, heavily booked, or unavailable on the required
                    date.
                  </p>
                  <p className="mt-5">
                  ...
                  <p className="mt-5">
                    ...
                    private charters on the Ramechhap-Lukla route. The direct
                    flight normally takes around 20 to 25 minutes. Travelers
                    interested in scenic extensions, additional landings, or
                    other personalized services should mention them during
                    booking. These requests are priced separately and remain
                    subject to weather, safety requirements, and operational
                    approval.
                  </p>
                </div>
              </section>
