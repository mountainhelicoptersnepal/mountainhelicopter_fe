...
const message =
  "Hi, I would like to know more about the Everest Mountain Overfly with Gokyo Lake Landing.";
...
export default function GokyoTourSidebar() {
  return (
