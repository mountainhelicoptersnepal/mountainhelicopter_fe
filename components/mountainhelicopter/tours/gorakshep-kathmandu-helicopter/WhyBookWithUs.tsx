...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Booking with us is simple, straightforward, and completely transparent. Before you confirm your reservation, you'll receive a detailed itinerary, clear pricing, and a full list of what's included in your Gorakshep to Kathmandu tour. With no hidden charges or surprise fees, you can book with confidence, knowing exactly what to expect from start to finish.",
  },
];
