...
const reasons = [
  ...
  },
  {
    ...
    title: "Best Pricing",
    description:
      "When you book with us, you're booking directly with the operator and not through a reseller or third-party agency. That means no agency markups, no hidden commissions, and no surprise fees.",
  },
  {
    icon: Clock3,
