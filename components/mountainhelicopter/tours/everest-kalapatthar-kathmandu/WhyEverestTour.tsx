const reasons = [
  ...
  [
    "Each passenger lands at Kala Patthar, stepping out onto the high ridge to experience the full Everest skyline from the ground.",
  ],
  [
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16 py-16 md:py-20 lg:py-28">
        <h2 className="text-center font-fraunces text-2xl font-semibold leading-none tracking-[0] text-[#061a3a] sm:text-[42px]">
          Why Fly the Everest Mountain Overfly with Kala Patthar Landing and
          Breakfast at HEV?
        </h2>
