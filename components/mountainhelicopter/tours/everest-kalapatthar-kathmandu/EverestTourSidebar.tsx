...
const message =
  "Hi, I would like to know more about the Everest Mountain Overfly with Kala Patthar Landing and Breakfast at Hotel Everest View.";
...
const groupPricing = [
  ["Group Joining Seat", "USD 3000"],
  ["Private Charter", "USD 6000"],
];
