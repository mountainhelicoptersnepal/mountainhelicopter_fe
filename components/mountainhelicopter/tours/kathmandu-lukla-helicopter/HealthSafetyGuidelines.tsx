      ...
      <div className="mx-auto max-w-7xl bg-[#061a31] px-6 md:px-12 lg:px-16 py-16 md:py-20 lg:py-28">
        ...
        <div className="mt-9 border-t border-white/10 pt-9">
          ...
          <p className="mt-7 max-w-[1180px] font-manrope text-base leading-8 text-white/68">
            At Lukla, the atmospheric pressure is approximately 70% of sea
            level. This means that with every breath, your lungs receive roughly
            half the oxygen you would at sea level. Most healthy people tolerate
            this without serious issues. However, your body does notice the
            difference.
          </p>
        </div>
