...
const plans = [
  {
    ...
    features: [
      ...
      "Shared seat on a scheduled flight",
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-6 md:px-12 lg:px-16 py-16 md:py-24 lg:py-28">
        ...
        <p className="mt-8 text-center font-manrope text-[12px] leading-6 text-[#7b8795] sm:text-[13px]">
          Fares exclude: airport taxes, national park fees, meals, gratuities,
          additional filming, separately transported baggage, and delay-related
