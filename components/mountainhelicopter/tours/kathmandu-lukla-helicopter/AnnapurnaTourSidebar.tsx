...
const message =
  "Hi, I would like to know more about the Kathmandu to Lukla Helicopter Flight.";
        ...
        <div className="p-5">
          ...
          <div className="mt-6">
            ...
            <p className="mt-3 font-manrope text-[9px] leading-4 text-slate-400">
              Prices are subject to weather, operating conditions, and available
              aircraft.
            </p>
          </div>
