const reasons = [
  "Our flight crews have intimate knowledge of the Langtang Conservation Area and know how to identify stable flight routes, even during challenging visibility conditions.",
...
export default function LangtangWhyUs() {
  return (
    <section
      id="why-us"
