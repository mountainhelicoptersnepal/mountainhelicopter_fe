...
<h2 className="max-w-[670px] font-fraunces text-[38px] font-semibold leading-[1.06] tracking-[-1px] text-[#003366] sm:text-[44px] lg:text-[51.2px] lg:leading-[54.27px] lg:tracking-[-1.02px]">
  <span>Overview of Muktinath Helicopter </span>
...
<div className="mt-6 flex w-full max-w-[672px] flex-col gap-6 font-font-manrope text-[17px] font-normal leading-[27.63px] tracking-[0px] text-[#0A1929]/80">
  <p>
    The Muktinath Helicopter rescue is dedicated to saving the life of
    trekkers due to the higher altitude (3710m) and harsh weather of
    Mustang region that sees a rise in emergency situations. The service
    is primarily for remote trial rescue operations when evacuation
    through ground routes is impossible. Helicopter rescue services will
    take place above 3700 meters up to as high as the 4200m passes, which
    are out of the capacity of typical helicopters. The aircraft we employ
    is designed specifically for rescue operations and coordination for
    the rescue mission shall be carried out through flight captains and
    trekking agents, along with insurance providers.
  </p>

  <h2 className="max-w-[670px] font-fraunces text-[38px] font-semibold leading-[1.06] tracking-[-1px] text-[#003366] sm:text-[44px] lg:text-[51.2px] lg:leading-[54.27px] lg:tracking-[-1.02px]">
    <span>Highlights of Rescue Operation in Muktinath Area</span>
  </h2>

  <ul className="list-disc space-y-3 pl-6">
    <li>
      Continuous emergency dispatch services are maintained across the
      entire Muktinath and Mustang conservation area.
    </li>

    <li>
      Rapid deployments are launched from the Pokhara or Kathmandu
      aviation hubs within a matter of hours.
    </li>

    <li>
      High-altitude flight missions are conducted using advanced turbine
      rotorcraft, specifically the Airbus H125 and Bell 407 models.
    </li>

    <li>
      Flight operations are executed by veteran aviators holding valid
      Civil Aviation Authority of Nepal (CAAN) certifications.
    </li>

    <li>
      Critical patient care is administered by trained paramedics and
      Wilderness First Responders during the aerial transit.
    </li>

    <li>
      In-flight medical stabilization is provided via onboard oxygen
      cylinders and comprehensive first-aid kits.
    </li>

    <li>
      Secure landing maneuvers are performed at high-risk altitudes,
      including Muktinath Temple, Jomsom, and Kagbeni.
    </li>

    <li>
      Direct medical transfers are facilitated to premium healthcare
      facilities located in Pokhara and Kathmandu.
    </li>

    <li>
      Expedited claim authorizations and documentation processes are
      managed directly with global travel insurance providers.
    </li>

    <li>
      A flawless safety record is upheld through meticulously planned
      mountain extraction operations.
    </li>
  </ul>
</div>
          </div>
          ...
          <aside className="flex w-full flex-col gap-4">
            ...
            <div className="flex w-full flex-col pt-4">
              <div className="flex w-full flex-col border-[0.67px] border-[#003366]/15 bg-[#EDF4FA] p-6">
                ...
                <Link
                  href="/tours/everest-base-camp-helicopter-tour"
                  className="group mt-4 inline-flex items-center gap-2 font-manrope text-[11px] font-medium uppercase leading-[15px] tracking-[1.5px] text-[#0062B1] transition-colors hover:text-[#003B70] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0062B1]"
                >
                  View
                  <ArrowRight
                    aria-hidden="true"
