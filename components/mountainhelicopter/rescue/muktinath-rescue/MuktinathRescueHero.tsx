...
export default function MuktinathRescueHero() {
      ...
      <div className="relative z-10 mx-auto flex min-h-[760px] max-w-[1280px] items-center px-5 pb-20 pt-16 md:px-8 lg:px-10">
        <div className="max-w-[900px]">
          ...
          <div className="mt-8 max-w-[760px] space-y-4 font-manrope text-[18px] leading-[1.6] text-white/85">
            <p>
              This Muktinath helicopter rescue is done for pilgrims, trekking
              groups, and expedition groups that get stuck in Muktinath. There
              is a wide range of Muktinath helicopter tour services in Nepal
              that many travelers love to book for a peaceful journey through
              the sky at high altitude. However, high-altitude helicopter
              pilots also arrange emergency evacuations. We rush into action
              immediately, especially when patients are in a life-threatening
              condition in the Himalayas, to prevent the situation from
              becoming worse.
            </p>
          </div>
