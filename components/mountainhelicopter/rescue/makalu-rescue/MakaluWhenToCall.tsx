// src/components/rescue/makalu/MakaluWhenToCall.jsx
...
const emergencyCards = [
  ...
  },
  {
    ...
    items: [
      "Falls and fractures on steep, rocky or glacial trails",
      "Head injuries caused by falls or rockfall",
      "Avalanche exposure in the Makalu-Barun region",
      "Rockfall and climbing injuries",
    ],
  },
  {
    ...
    items: [
      "Exhaustion and severe dehydration during expedition stages",
      "Food poisoning and gastrointestinal illness",
      "Cardiac events caused by extreme physical strain",
      "Stroke",
      "Respiratory illness",
    ],
  },
  {
    ...
    items: [
      "Hypothermia caused by sudden weather changes",
      "Lost or separated trekkers and expedition members",
      "Weather-related emergencies",
      "Blocked, unsafe or inaccessible descent routes",
    ],
  },
];
      ...
      <div className="relative flex flex-1 flex-col px-5 py-5 sm:px-6">
        <ul className="space-y-3">
          {items.map((item) => (
            ...
            >
              <span className="mt-[7px] h-[6px] w-[6px] shrink-0 rounded-full border border-[#b77900] bg-transparent transition-all duration-300 group-hover:scale-110 group-hover:bg-[#f2a10d]" />
...
export default function MakaluWhenToCall() {
  return (
    <section
      id="when-to-call"
      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="max-w-[980px]">
          ...
          <h2 className="mt-4 max-w-[1100px] font-fraunces text-[40px] font-semibold leading-[1.03] tracking-[-0.03em] text-[#071825] sm:text-[50px] lg:text-[60px]">
            When Is Helicopter Rescue Necessary in Makalu Base Camp?
          </h2>

          <div className="mt-5 max-w-[850px] space-y-5 font-manrope text-[11px] leading-[1.8] text-[#4d5963] sm:text-[12px]">
            <p>
              Not every symptom on the trail is immediately life-threatening.
              Some patients may be monitored while resting or descending under
              supervision. The critical decision is recognizing when waiting is
              no longer safe.
            </p>
            ...
            <p>
              ...
              injury, or is stranded by weather or terrain in the remote
              Makalu-Barun region.
            </p>

            <p>Common situations that may require rescue include:</p>
          </div>
        </div>
