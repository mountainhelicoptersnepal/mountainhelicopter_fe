...
<div className=" mx-auto flex min-h-[602px] w-full max-w-[1440px] flex-col items-center justify-center px-5 py-20 text-center sm:px-8 lg:px-12 xl:px-[180px] 2xl:px-[279px] " >
        ...
        {/* Main action buttons */}
        <div className=" mt-7 flex w-full max-w-[650px] flex-col items-stretch justify-center gap-3 sm:flex-row " > <a href="mailto:info@mountainhelicoptersnepal.com" className=" inline-flex min-h-[46px] items-center justify-center gap-2 border border-white/35 px-6 font-manrope text-[9px] font-bold uppercase leading-[14px] tracking-[0.16em] text-white transition-colors hover:border-[#F2B632] hover:text-[#F2B632] sm:min-w-[190px] " >
            <Mail
              aria-hidden="true"
          ...
          <a
            ...
            className=" inline-flex min-h-[46px] items-center justify-center gap-3 bg-[#D62828] px-7 font-manrope text-[10px] font-bold leading-[14px] tracking-[0.08em] text-white transition-colors hover:bg-[#B91F1F] sm:min-w-[220px] " >
