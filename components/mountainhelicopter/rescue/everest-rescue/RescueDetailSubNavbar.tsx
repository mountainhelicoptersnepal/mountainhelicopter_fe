...
export default function RescueDetailSubNavbar() {
  ...
  const smoothScrollToSection = (href) => {
    ...
    smoothScrollTo(sectionPosition, 800);
            ...
            {navItems.map((item) => {
              ...
              return (
                <a
                  ...
                  className={`inline-flex h-[30px] shrink-0 items-center justify-center px-[18px] py-[7px] font-[var(--font-manrope)] text-[11px] font-semibold uppercase leading-[16.5px] tracking-[1.1px] transition-colors duration-200 ${
                    isActive
