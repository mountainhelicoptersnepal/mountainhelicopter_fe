...
export default function TilichoRescueHero() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/rescue/regions/tilicho.jpg')",
        }}
      />
        ...
        <div className="mx-auto flex max-w-[1280px] items-center justify-between px-5 py-5 md:px-8 lg:px-10">
          ...
          <div className="hidden items-center gap-5 lg:flex">
            <button
              ...
              className="text-white transition hover:text-[#f3b323]"
            >
              <Menu size={22} />
            </button>
      ...
      <div className="relative z-10 mx-auto flex min-h-[760px] max-w-[1280px] items-center px-5 pb-20 pt-16 md:px-8 lg:px-10">
        <div className="max-w-[900px]">
          ...
          <h1 className="max-w-[980px] font-fraunces text-[46px] font-semibold leading-[0.98] tracking-[-1.6px] text-white sm:text-[58px] md:text-[72px] lg:text-[65px]">
            Tilicho Helicopter Rescue
            <br />
            <span className="italic text-[#f3b323]">24/7 Emergency</span>{" "}
            Evacuation
          </h1>

          {/* Paragraph */}
          <div className="mt-8 max-w-[780px] font-manrope text-[18px] leading-[1.6] text-white/85">
            <p>
              Tilicho Helicopter Rescue helicopter services can be utilized for
              emergency air rescue of trekkers, guides, and porters who
              encounter serious medical problems or face life threats at and
              around the Tilicho Lake trek. It is mostly needed during an
              emergency on and off from Manang, Khangsar, Shree Kharka, Tilicho
              Base Camp, Tilicho Lake, and nearby regions of the Annapurna
              Circuit when going down the way proves very unsafe, too slow, or a
              medical risk for the patients.
            </p>
          </div>
