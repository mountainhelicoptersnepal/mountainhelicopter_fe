...
export default function AnnapurnaWhenToCall() {
  return (
    <section
      id="when-to-call"
      className="scroll-mt-[123px] bg-[#F8FAFC] px-5 py-16 sm:px-8 lg:px-12 lg:py-20 xl:px-[80px] 2xl:px-[125px]"
    >
      <div className="mx-auto max-w-[1440px]">
        <div className="max-w-[900px]">
          ...
          <div className="mt-5 max-w-[820px] space-y-5 font-manrope text-[11px] leading-[1.8] text-[#4d5963] sm:text-[18px]">
            <p>
              Not all symptoms are that urgent and you can decide to monitor
              them until you can go back down or call a helicopter if it is
              needed. Deciding the difference between the decision of “watch and
              walk down” versus the decision of “let's take a helicopter out
              right now”, it's probably the one the most important decision a
              trek leader and a trekking party will make.
            </p>
            ...
            <div className="mx-auto flex min-h-[330px] w-full max-w-[1091px] items-center justify-center rounded-[18px] border-l-2 border-[#c65c00] bg-[#003366] px-6 py-10 text-white sm:px-8 lg:px-12">
              <div className="flex min-h-[235px] w-full max-w-[672px] flex-col justify-center gap-[22px]">
                ...
                <p className="max-w-[650px] font-manrope text-sm leading-7 text-white/75 sm:text-base sm:leading-8">
                  ...
                  unmistakable. If someone above 3,500 m is deteriorating, do
                  not wait to be certain. Call us. The cost of a rescue call
                  that turns out to be unnecessary is zero. The cost of delaying
                  a rescue that was needed can be a life.
                </p>
